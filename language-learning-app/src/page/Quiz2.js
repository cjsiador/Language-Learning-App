...
import GreetingsAndSelfIntroduction from "../data/GreetingsAndSelfIntroduction.json"
...
const Quiz = () => {
    ...
    const SelectRandomPhase = () => {
        ...
        const allItems = Object.values(GreetingsAndSelfIntroduction.lesson).flat();
        ...
        const remainingItems = allItems.filter(item => item.phrase !== chosenItem.phrase);
        ...
        const combinedItems = [{ phrase: chosenItem.phrase, romaji: chosenItem.romaji, translation: chosenItem.translation, breakdown: chosenItem.breakdown}, ...randomItems];
    ...
    const answerChoices = (choices, index) => {
        ...
        if (selectedQuizItem.translation !== choices) {
            ...
            descriptionRef.current.innerText = `${selectedQuizItem.translation}`;
            setContinuing(false);
        }
                        ...
                        <Box>
                            ...
                            <Box 
                                ...
                                <Box>
                                    ...
                                    <Text p="12" fontWeight="20px" color='white' fontSize="32px" mt="-100px">Greetings And Self Introduction</Text>
                                </Box>
                                                                ...
                                                                <Box>
                                                                    {selectedItems.map((item, i) => (
                                                                        <Button                                                                                
                                                                            ...
                                                                            onClick={() => answerChoices(item.translation, i)}
                                                                            fontSize="10px"
                                                                            marginTop="5px"
                                                                            key={i}
                                                                        >
